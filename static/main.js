...
var calculation_names = {
  ...
  "pad_to_bytes": "Display padded bytes",
  ...
  render() {
    ...
    return React.createElement("div",null,
      React.createElement("div",{id:"add-step-picker"},
        React.createElement("div",{id:"add-number","class":"step-type"},React.createElement("div",{"class":"form-item"},React.createElement("label",{"for":"numeric-base"},"Base"),React.createElement("select",{id:"numeric-base",onChange:this.changeBase,value:this.state.base},React.createElement("option",{value:"2"},"Binary"),React.createElement("option",{value:"8"},"Octal"),React.createElement("option",{value:"10"},"Decimal"),React.createElement("option",{value:"16"},"Hexadecimal"),React.createElement("option",{value:"BCD"},"BCD"))),React.createElement("div",{"class":"form-item"},React.createElement("label",{id:"numeric-digits"},"Digits ",React.createElement("span",{"class":"note"},"(- for negative)")),React.createElement("input",{type:"text",name:"numeric-digits",onChange:this.changeNumeric,value:this.state.numeric})),React.createElement("div",{"class":"form-item"},React.createElement("button",{name:"submit-number",onClick:this.submitNumber},"Create New Number"),React.createElement("label",{"for":"submit-number",id:"submit-number"}))),
        React.createElement("div",{id:"add-calc","class":"step-type"},React.createElement("div",{"class":"form-item"},React.createElement("label",{"for":"calculation"},"Calculations"),React.createElement("select",{id:"calculation",onChange:this.changeCalcType,value:this.state.calcType},React.createElement("option",{value:"2"},"Convert to Binary"),React.createElement("option",{value:"8"},"Convert to Octal"),React.createElement("option",{value:"10"},"Convert to Decimal"),React.createElement("option",{value:"16"},"Convert to Hexadecimal"),React.createElement("option",{value:"BCD"},"Convert to BCD"),React.createElement("option",{value:"add"},"Add next number"),React.createElement("option",{value:"numerals"},"Display as numerals"),React.createElement("option",{value:"value"},"Display base 10 value"),React.createElement("option",{value:"pad_to_bytes"},"Display padded bytes"),React.createElement("option",{value:"sign_and_magnitude"},"Display Sign and Mag."),React.createElement("option",{value:"one_complement"},"Display 1's Complement"),React.createElement("option",{value:"two_complement"},"Display 2's Complement"))),React.createElement("div",{"class":"form-item"},React.createElement("button",{name:"submit-calc",onClick:this.submitCalc},"Create New Calculation"),React.createElement("label",{"for":"submit-calc",id:"submit-calc"})))),
